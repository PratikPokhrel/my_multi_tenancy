...
namespace Infrastructure.Services
{
    public class ExcelService : IExcelService
    {
        ...
        public async Task<Result<IEnumerable<TEntity>>> ImportAsync<TEntity>(Stream stream, Dictionary<string, Func<DataRow, TEntity, object>> mappers, string sheetName = "Sheet1")
        {
            ...
            if (ws == null)
            {
                return await Result<IEnumerable<TEntity>>.FailAsync("Failed to import");
            }
            ...
            return await Result<IEnumerable<TEntity>>.SuccessAsync(result,"Imported successfully");
        }
    }
}
