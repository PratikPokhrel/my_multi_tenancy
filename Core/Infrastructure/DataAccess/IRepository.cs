...
namespace Core.Infrastructure.DataAccess
{
    ...
    public interface IRepository<T>
    {
        ...
        Task<List<TType>> GetAllAsync<TType>(Expression<Func<T, bool>> where, Expression<Func<T, TType>> select, bool asNoTracking = false, Func<IQueryable<T>, IOrderedQueryable<T>> orderBy = null);
